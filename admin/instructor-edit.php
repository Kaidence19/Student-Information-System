    ...
    <?php 
     ...
     <div class="container mt-5">
        ...
        <form method="post"
              ...
              action="req/instructor-edit.php">
        ...
        <div class="mb-3">
          ...
          <input type="text" 
                 class="form-control"
                 value="<?=$instructor['contact_number']?>"
                 name="contact_number">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" 
                 class="form-control"
                 value="<?=$instructor['email_address']?>"
                 name="email_address">
        </div>
        <div class="mb-3">
          ...
          <input type="radio"
                 value="Male"
                 <?php if($instructor['gender'] == 'Male') echo 'checked';  ?> 
                 name="gender"> Male
                 &nbsp;&nbsp;&nbsp;&nbsp;
          <input type="radio"
                 value="Female"
                 <?php if($instructor['gender'] == 'Female') echo 'checked';  ?> 
                 name="gender"> Female
        </div>
        <input type="text"
        ...
        <div class="mb-3">
          ...
          <div class="row row-cols-5">
            <?php 
            $subject_ids = str_split(trim($instructor['subjects']));
        ...
        <div class="mb-3">
          <label class="form-label">Handled Class</label>
          <div class="row row-cols-5">
            <?php 
